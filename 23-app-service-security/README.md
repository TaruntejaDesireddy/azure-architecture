...
![Module](https://img.shields.io/badge/Module-23-0078D4?style=flat-square&logo=microsoftazure&logoColor=white)
...
- [App service security](https://github.com/TaruntejaDesireddy/azure-soc-lab/blob/main/AZ-500-REFRESH/15-app-service-security.md) &nbsp;·&nbsp; `AZ-500-REFRESH`

**Architect view**

- [Application and api review](https://github.com/TaruntejaDesireddy/azure-soc-lab/blob/main/SC-100-PATH/13-application-and-api-review.md) &nbsp;·&nbsp; `SC-100-PATH`
